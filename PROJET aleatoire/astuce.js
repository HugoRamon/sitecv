function liste_astuces()
{
	...
	C'est le symbole Accent circonflexe (<strong>^</strong>) qui permet de monter un nombre à la <strong>puissance</strong>. Si A1 vaut 5 et que A2 vaut <strong>=A1^3</strong>, le résultat est 125.| \
